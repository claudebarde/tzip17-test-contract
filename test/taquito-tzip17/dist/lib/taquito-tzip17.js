...
var ContractMethodTzip17 = /** @class */ (function () {
    ...
    ContractMethodTzip17.prototype.createTransferParam = function () {
        var _a;
        return (_a = this.method.apply(this, __spreadArray([], __read(this.args), false)).toTransferParams().parameter) === null || _a === void 0 ? void 0 : _a.value;
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        packedParam = _a.sent();
                        return [2 /*return*/, (0, utils_1.buf2hex)(Buffer.from((0, blakejs_1.blake2b)(packedParam)))];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, (0, michel_codec_1.packDataBytes)(sigParamData(chainId, this.contractAbs.address, counter, methodHash), sigParamType)];
                }
            });
        });
    };
...
//# sourceMappingURL=taquito-tzip17.js.map